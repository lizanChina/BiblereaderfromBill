...
public class TxtReadView extends View {
    ...
    private ITxtPageChangeListsner txtPageChangeListsner;
    private ITxtViewCenterAreaTouchListener txtViewCenterAreaTouchListener;
    private IPageSeparateListener pageSeparateListener;
    ...
    public ITxtManager getTxtMAnager() {
        if (mManager == null) {
    ...
    public void setTxtManager(ITxtManager txtManager) {
    ...
    public void init() {
        ...
        txtModel.setModeToViewTransform(new IModeToViewTransform() {
            ...
            @Override
            public void onloadpagefromindex(Boolean isfirstpage,
                                            Boolean islastpage) {
            ...
            public void onPageSeparateDone() {
                ...
                if (txtPageChangeListsner != null) {
                    ...
                    txtPageChangeListsner.onCurrentPage(pageindex,
                            txtModel.getPageNums());
                }
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (behideBitmap != null) {
            ...
            Rect dstRect1 = new Rect((int) behi_leftX, 0, behi_rigthX,
                    getViewHeigh());// bmp1在目标画布中的位置
    ...
    private Paint getBgLightPaint() {
        ...
        LinearGradient gradient = new LinearGradient(divider_position
                - shadowwith, 0, divider_position, 0, new int[]{
                Color.parseColor("#00666666"), Color.parseColor("#11666666"),
                Color.parseColor("#33666666"), Color.parseColor("#44666666"),
                Color.parseColor("#88666666"), Color.parseColor("#ee666666")},
    ...
    private void doMove(MotionEvent event) {
        ...
        if ((pagedragstate == PAGE_UP || pagedragstate == PAGE_NONE)
                && currentisfirstpage) {// 第一页不允许执行前一页操作
            pagedragstate = PAGE_NONE;
            Logger.d("this is the firstpage");
            return;
        }

        if ((pagedragstate == PAGE_DOWN || pagedragstate == PAGE_NONE)
                && currentislastpage) {// 最好一页不允许执行下一页操作
            pagedragstate = PAGE_NONE;
            Logger.d("this is the lastpage");
            return;
        }
        ...
        if (pagedragstate == PAGE_UP && divider_position >= getViewWith()
                && movex > 0) {
            divider_position = 0;
            justslidtoleft();
            return;
        ...
        divider_position = divider_position >= getViewWith() ? getViewWith()
                : divider_position;
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (p > 0) {
                    ...
                    if (txtPageChangeListsner != null) {
                        ...
                        pageindex = midpage == null ? 0 : midpage
                                .getPageindex();
                        txtPageChangeListsner.onCurrentPage(pageindex,
                                txtModel.getPageNums());
                    }
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (divider_position < getViewWith() - 5) {
                    ...
                    if (txtPageChangeListsner != null) {
                        ...
                        pageindex = predpage == null ? 1 : predpage
                                .getPageindex();
    ...
    public void setOnTxtPageChangeListener(
            ITxtPageChangeListsner ITxtPageChangeListsner) {

        this.txtPageChangeListsner = ITxtPageChangeListsner;
    }

    public void setOnTxtViewCenterAreaTouchListener(
            ITxtViewCenterAreaTouchListener ITxtViewCenterAreaTouchListener) {
        this.txtViewCenterAreaTouchListener = ITxtViewCenterAreaTouchListener;
    }

    public void setOnPageSeparateListener(
            IPageSeparateListener IPageSeparateListener) {
        this.pageSeparateListener = IPageSeparateListener;
    }

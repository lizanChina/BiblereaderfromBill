...
public class TxtProgressMenu extends PopupWindow {
    ...
    private void inite() {
        ...
        RelativeLayout layout = (RelativeLayout) LinearLayout.inflate(mContext,
                R.layout.txtprogressmenu_layout, null);
        ...
        mLoadinglayout = (LinearLayout) layout
                .findViewById(R.id.txtprogress_layout1);
        mViewlayout = (LinearLayout) layout
                .findViewById(R.id.txtprogress_layout2);

...
public class TxtBrightMenu extends PopupWindow {
    ...
    private void inite() {
        ...
        RelativeLayout layout = (RelativeLayout) LinearLayout.inflate(mContext,
                R.layout.txtlightmenu, null);
        ...
        mSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar arg0, int arg1, boolean arg2) {
                ...
                WindowManager.LayoutParams wl = ((Activity) mContext)
    ...
    private void SaveSystemdefaultBrignhtness(Context mContext) {
        ...
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(
                "SYSTEM_BRIGHTNESS", Context.MODE_PRIVATE);
        sharedPreferences.edit()
                .putInt("brightness_value", getScreenBrightness(mContext))
                .commit();
